...
<div class="general">
        ...
        <form action="" method="POST">
            <div class="cadre-vente">
                ...
                <button class="ajout-article" @click.stop="addLine()">Ajouter un article</button>
                ...
                <div class="commande">
                    <table class="tableau">
                        ...
                        <tbody>
                            <tr  v-for="(sell_line, i) in sell_lines" :key="i">
                            <form action="">
                                <td><input type="number" placeholder="000" min="0" max="100" v-model="form.product_id" autocomplete="off" required></td>
                                <td><input type="number" placeholder="000" min="0" max="100" v-model="form.quantity" autocomplete="off" required></td>
                                <td><input type="number" placeholder="000" min="0" max="100" v-model="form.price" autocomplete="off" required></td>
                                <td><input type="number" placeholder="000" min="0" max="100" v-model="form.amount" autocomplete="off" required></td>
                            </form>
                            </tr>
                        </tbody>
                    </table>     
