            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item active open">
                        <NuxtLink to="" class="menu-link menu-toggle">
...
export default {
    head: {
      ...
      { rel: 'stylesheet', href: 'assets/vendor/libs/datatables-bs5/datatables.bootstrap5.css' },
      { rel: 'stylesheet', href: 'assets/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css' },
      { rel: 'stylesheet', href: 'assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css' },
      { rel: 'stylesheet', href: 'assets/vendor/css/pages/cards-advance.css' },
        ],
      ...
      { src: 'assets/vendor/libs/node-waves/node-waves.js', type: 'text/javascript' },
      ...
      { src: 'assets/vendor/libs/swiper/swiper.js', type: 'text/javascript' },
      { src: 'assets/vendor/libs/datatables-bs5/datatables-bootstrap5.js', type: 'text/javascript' },
      { src: 'assets/js/main.js', type: 'text/javascript' },
      { src: 'assets/js/dashboards-crm.js', type: 'text/javascript' },
        ]
    },
    name: "NewSidebar",
