            ...
            <div class="alert alert-danger justify-content-center" role="alert" v-if="error">
                ...
                <form action="" method="POST">
                    ...
                    <div class="col-md-6 mx-auto">
                        <button class="custom-btn btn-5 col-md-12" v-on:click.prevent="submit()" :disabled="load">Enregistrer le dévis</button>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            choiceProd(designation,i){
                console.log(i);
                let line = this.form.devis_lines[i]
                  ...
                  compagnie_id: localStorage.getItem('auth.company_id') 
                    ...
                    // console.log(this.form.client_id)
                        if(response.data.status == "success"){
                            ...
                            this.$toast("Enregistrement d'un devis !!! ", {
