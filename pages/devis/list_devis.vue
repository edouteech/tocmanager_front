<template >
    <div>
        ...
        <div class="app-main__outer py-5 px-2">
          <h4>Liste des devis enregistrés</h4><hr><br>
          ...
          <div class="d-flex">
            ...
            <NuxtLink  to="/devis/devis" v-for="(user, i) in users" :key="i" class="web-btn"><button class="custom-btn btn-3" v-if="compagny == user.pivot.compagnie_id && user.pivot.droits_add == 1"><span>Ajouter nouveau devis</span></button></NuxtLink>
          </div>
          <div class="mobile-btn my-4">
            <NuxtLink  to="/devis/devis" v-for="(user, i) in users" :key="i"><button class="custom-btn btn-3" v-if="compagny == user.pivot.compagnie_id && user.pivot.droits_add == 1"><span>Ajouter nouveau devis</span></button></NuxtLink>
          </div>
            ...
            <table class="table table-hover" v-if="this.element_search == ''">
              ...
              <tbody>
               <tr  v-for="(devi, i) in devis" :key="i">
                  ...
                  <td><div class="action d-flex aligns-items-center justify-content-center" v-for="(user, i) in users" :key="i">
                    <NuxtLink :to="'/devis/voir/'+devi.id" v-if=" compagny == user.pivot.compagnie_id"><i class="fa fa-info-circle text-info" aria-hidden="true"></i></NuxtLink>
                    <NuxtLink :to="'/devis/'+devi.id" v-if=" compagny == user.pivot.compagnie_id && user.pivot.droits_edition == 1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></NuxtLink>
                    <div @click="deleteClient(devi.id)" v-if=" compagny == user.pivot.compagnie_id && user.pivot.droits_delete == 1"><i class="fa fa-trash-o text-danger" aria-hidden="true"></i></div>
                  </div>
                  </td>
                </tr>
              </tbody>
            </table>
            <p class="text-center"><strong>{{total}} devis au total </strong></p><hr class="text-primary">
          </div><br><br>
