<template >
    <div>
        ...
        <div class="app-main__outer p-5">          
          <div class="p-2 mb-2 bg-secondary text-white text-center"><h4>Informations sur l'exercice</h4></div><br>
          <div class="">
            <p><strong>Nom de l'exercice : {{name_exercice}}</strong> </p>
            <p><strong> Date de début : {{start_at}}</strong> </p>
            <p><strong> Date de fin : {{end_at}}</strong> </p>
          ...
          <!-- <table class="table table-hover">
            ...
            <h5><p class="text-center">Listes des ecritures de cet exercice</p></h5>
