<template>
    <div>
        ...
        <div class="app-main__outer p-5">
          <h4>Liste des exercices</h4><hr><br><br>
          <div class="d-flex">
              <div class="col-md-10">
              ...
              <NuxtLink  to="/exercices/add_exercice" v-for="(user, i) in users" :key="i" class="web-btn"><button class="custom-btn btn-3" v-if="compagny == user.pivot.compagnie_id && user.pivot.droits_add == 1"><span>Ajouter exercice</span></button></NuxtLink>
          </div>
    
          <div class="mobile-btn mt-4"><NuxtLink  to="/exercices/add_exercice" v-for="(user, i) in users" :key="i"><button class="custom-btn btn-3" v-if="compagny == user.pivot.compagnie_id && user.pivot.droits_add == 1"><span>Ajouter exercice</span></button></NuxtLink></div>
          ...
          <div class="table-responsive">
            ...
            <p class="text-center"><strong>{{total}} exercices(s) au total </strong></p><hr class="text-primary">
    ...
    export default {
      ...
      methods: {
            ...
            refresh(page=1){
              this.$axios.get('/exercices',{params: {
