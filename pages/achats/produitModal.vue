    ...
    <div class="modaler" @click.stop>  
      <div class="alert alert-danger justify-content-center" role="alert" v-if="status == 'error'">
        ...
        <form action="" method="POST">
            ...
            <div class="alert-danger justify-content-center" role="alert" v-if="errors['category_id'] != null">{{errors['category_id']}}</div> 
            ...
            <div class="input-form">        
                <input type="text" placeholder="Entrer le code du produit " v-model="form.code" id="quantite" required>
            </div>
