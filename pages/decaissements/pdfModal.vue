<template>
    <div class="modal-overlay"  @click="$emit('close-modal')">
      <div class="modaler" @click.stop>
        <h6 class="text-center">Télécharger la liste des décaissements !</h6>
  ...
  <script>
    export default {
      ...
      methods:{
        pdf() {
          this.$axios.get('/decaissements/download', {
            params: {
            ...
            link.href = url;
            link.setAttribute('download', 'decaissements.pdf'); //or any other extension
