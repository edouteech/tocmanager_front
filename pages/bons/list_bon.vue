<template >
  <div>
    ...
    <div class="app-main__outer py-5 px-2">
      <h4>Liste des bons de commande enregistrés</h4>
      <hr />
      <br />
      <div
      ...
      <div class="mobile-btn my-4">
        <NuxtLink to="/bons/add_bon" v-for="(user, i) in users" :key="i"
          ><button
            class="custom-btn btn-3"
            v-if="
              compagny == user.pivot.compagnie_id && user.pivot.droits_add == 1
      ...
      <div class="table-responsive">
        ...
        <p class="text-center">
          <strong>{{ total }} bons au total </strong>
        </p>
