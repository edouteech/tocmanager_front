<template>
            ...
            <div class="alert alert-danger justify-content-center" role="alert" v-if="error">
                ...
                <form action="" method="POST">
                    ...
                    <div class="col-md-6 mx-auto">
                        <button class="custom-btn btn-5 col-md-12" v-on:click.prevent="submit()" :disabled="load">Enregistrer le bon de commande</button>
                    </div>
    ...
    export default {
        ...
        addLine(){
            this.form.order_lines.push({product_id: "", price: 0, quantity: 1, amount: 0, compagnie_id: localStorage.getItem('auth.company_id'), date: this.form.date_buy});
        },
