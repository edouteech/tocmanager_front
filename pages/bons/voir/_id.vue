<template>
    <div>
        ...
        <div class="app-main__outer py-5 px-2">
                <h4 class="boom">Informations relatives à ce bon de commande </h4><hr class="boom">
                <div class="row my-5">
                    <div class="col-md-6 boom">
                         <NuxtLink class="btn btn-outline-success col-md-12" v-on:click.prevent="submit()" :disabled="load" :to="'/achats/bon/'+bon_id">Enregistrer le bon comme un achat</NuxtLink>
                    </div>
                    <div class="col-md-6 boom">
                        <button class="btn btn-outline-dark col-md-12" v-on:click.prevent="submit()" :disabled="load">Imprimer le bon de commande</button>
                    </div>
                </div>
