<template>
  <div>
    ...
    <div class="app-main__outer py-5 px-2">
      ...
      <h4>Modifier le bon de commande</h4>
      <hr />
...
export default {
  ...
  methods: {
    ...
    //rappeler la fonction recupProduct après le modal
    setProduit(payload) {
      this.recupProduct();
    },
    ...
    //changer le montant en fonction de la quantité
    ...
    //changer le produit dans les lignes d'achat
...
.btn-5 {
  ...
  padding: 20px;
  border: none;
  background: rgb(79, 250, 37);
  background: linear-gradient(0deg, rgb(85, 245, 40) 0%, rgb(56, 245, 4) 100%);
}
.btn-5:hover {
  color: #09f01c;
  background: transparent;
