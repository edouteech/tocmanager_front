<template>
  <div>
    ...
    <div class="app-main__outer py-5 px-2">
      ...
      <h4 class="mx-4">Modifier mot de passe</h4>
      <hr />
      <br />
      <div class="row">
          ...
          <div class="form-outline mb-3">
            ...
            <div class="input-field">
              <input
                ...
                placeholder="Entrer un mot de passe"
              /><span
                ><i class="fa fa-eye px-2" id="eye" @click.prevent="chang()"></i
              ></span>
            </div>
          </div>
...
export default {
  ...
  methods: {
    //afficher et cacher len nouveau mot de passe
    chang() {
    ...
    //afficher et cacher l'ancien mot de passe
    changer() {
    ...
    //afficher et cacher la confirmation du nouveau mot de passe
    change() {
