    ...
    <div class="app-main__outer p-5">
      ...
      <form action="" method="POST">
        <div class="cadre-haut">
          <div class="ajout-client">
            <div class="form-group">
              ...
              <input
                type="text"
                class="form-control"
                v-model="form.name_ecriture"
                autocomplete="off"
                required
                placeholder="Nom de l'écriture"
              />
            </div>
          </div>
          <div class="ajout-client">
            <div class="form-group">
              <label class="title">Type journal</label>
              <select
                class="form-control"
                name="type_journal"
                id="type_journal"
                v-model="form.code_journal"
              >
                <option value="HA">Achat</option>
                <option value="VT">Vente</option>
          ...
          <div class="ajout-client">
            <div class="form-group">
              <label class="title">Numéro de la facture</label>
              <input
                type="number"
                class="form-control"
                name="invoice_number"
        ...
        <div class="add_buttons d-flex flex-row-reverse">
          ...
          <button class="ajout-article col-md-6" @click.prevent="addLine()">
            <i class="fa fa-plus-circle" aria-hidden="true"></i> Ajouter une
            ligne écriture
          </button>
        </div>
        ...
        <br /><br /><br /><br /><br />
        <button class="custom-btn btn-5" v-on:click.prevent="submit()">
          Enregistrer l'écriture<span v-if="this.form.amount != ''">
            pour
...
export default {
  ...
  methods: {
    ...
    async submit() {
      ...
      await this.$axios
        .post("/ecritures", {
          ...
          code_journal: this.form.code_journal,
    ...
    addLine() {
      this.form.ligne_ecritures.push({
        compte_id: "",
        side: "",
        date: this.form.date,
        amount: 0,
    ...
    compteChange(code, indexLigneEcriture) {
      this.form.ligne_ecritures[indexLigneEcriture].numero_compte = code;
    //   console.log(this.form.ligne_ecritures);
    },
  },
};
</script>
