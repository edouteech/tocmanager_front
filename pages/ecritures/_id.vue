<template>
    <div>
        ...
        <div class="app-main__outer p-5">
            ...
            <h4>Modifier les informations de cette écriture</h4>
            <form action="" method="POST">
                ...
                <div class="d-flex">
                    ...
                    <div class="form-group col-md-6 mx-5">
                        <div class="form-group ">
                            Commentaire
                            <textarea name="" id="" cols="30" autocomplete="off" rows="10" class="form-control"
...
export default {
    ...
    mounted() {
        ...
        this.$axios.get('ecritures/' + this.$route.params.id, {
            params: {
            ...
            .then(response => {
                ...
                this.form.name_ecriture = response.data.data.name_ecriture
                this.form.comment = response.data.data.comment
                this.form.exercice_id = response.data.data.exercice_id
                
                response.data.data.ligne_ecritures.forEach(eachLigne => {
                    if (eachLigne['side'] == 'Debit') {
                        eachLigne['side'] = 0
                        this.form.ligne_ecritures.push(eachLigne)
                    } else {
                        eachLigne['side'] = 1
                        this.form.ligne_ecritures.push(eachLigne)
                    }
    ...
    methods: {
        ...
        async submit() {
            await this.$axios.put('/ecritures/' + this.$route.params.id, {
                ...
                exercice_id: this.form.exercice_id,
                compagnie_id: localStorage.getItem('auth.company_id'),
        ...
        addLine() {
            this.form.ligne_ecritures.push({ compte_id: "", side: "", amount: 0, date: this.form.date, compagnie_id: localStorage.getItem('auth.company_id') });
        },
        deleteLine(index) {
            //   console.log(index);
