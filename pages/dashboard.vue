<template>
  <div>
    ...
    <nav class="navbar navbar-fixed-top navbar-dark bg-dark text-white p-3">
      <Sidebar />
      <h3 class="name_side">Tableau De Bord</h3>
      <Userinfo />
    </nav>
          ...
          <div class="page-title-wrapper">
            <div class="page-title-heading">
              <div class="page-title-icon">
                <i
                  class="fa fa-thermometer-three-quarters text-danger"
                  aria-hidden="true"
                ></i>
              </div>
              <div>
                ...
                <div class="page-title-subheading">
                  Vue résumée des divers composants
                </div>
              </div>
            </div>
        ...
        <form action="action" method="POST">
          <div class="range">
            ...
            <input
              ...
              required
            />
            <div class="visualiser" @click="Visualiser()">
              ...
              <div class="tab-content">
                <div class="tab-pane fade show active d-flex" id="tabs-eg-77">
                  <div class="col-md-12 col-lg-6">
                    <h6
                      class="text-muted text-uppercase opacity-8 font-weight-normal"
                    >
                      Top des 10 produits les plus vendus
                    </h6>
                      ...
                      <div class="scrollbar-container">
                        ...
                        >
                          ...
                          <li
                            ...
                            v-for="(produits_vendus1, j) in produits_vendus"
                            :key="j"
                          >
                            <div class="widget-content p-0">
                    ...
                    <div class="scroll-area-sm">
                      <div class="scrollbar-container">
                        ...
                        >
                          ...
                          <li
                            class="list-group-item"
                            v-for="(produits_achetes1, k) in produits_achetes"
                            :key="k"
                          >
                            <div class="widget-content p-0">
                              <div class="widget-content-wrapper fsize-1">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="main-card mb-3 card">
              <div class="card-header">Dernières ventes éffectuées</div>
              <div class="table-responsive">
                ...
                >
                  ...
                  <tbody>
                    <tr
                      v-for="(dernieres_ventes1, i) in dernieres_ventes"
                      :key="i"
                    >
                      ...
                      <td class="text-center">
                        {{ dernieres_ventes1.date_sell }}
                      </td>
                      <td class="text-center">
                        <div class="badge badge-success fsize-1">
                          {{ dernieres_ventes1.amount }}
                        </div>
                      </td>
                      <td class="text-center">
                        <NuxtLink :to="'/ventes/voir/' + dernieres_ventes1.id">
                          <button
                            type="button"
                            id="PopoverCustomT-1"
...
export default {
  ...
  methods: {
    ...
    //raffraichir les infos du tableau de bord avec en paramètres les dates
    Visualiser() {
      this.$axios
        .post("/tableau/de/bord", {
          date_debut: this.form.date_debut,
