<template>
  <div>
    <nav class="navbar navbar-fixed-top navbar-dark bg-dark text-white p-3">
      <Sidebar />
      <h3 class="name">Comptes comptables</h3>
      <Userinfo />
    </nav>
    ...
    <div class="app-main__outer p-5">
      ...
      <div class="mobile-btn mt-4">
        <NuxtLink to="/comptes/add_compte" v-for="(user, i) in users" :key="i"
          ><button
            class="custom-btn btn-3"
            v-if="
              compagny == user.pivot.compagnie_id && user.pivot.droits_add == 1
      ...
      <div class="table-responsive">
        ...
        <p class="text-center">
          <strong>{{ total }} compte (s) au total </strong>
        </p>
