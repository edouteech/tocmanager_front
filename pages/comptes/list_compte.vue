  ...
  <div>
    ...
    <div class="app-main__outer p-5">
      ...
      <div class="d-flex">
        ...
        <NuxtLink to="/comptes/add_compte" v-for="(user, i) in users" :key="i" class="web-btn"><button
            class="custom-btn btn-3"
            v-if="compagny == user.pivot.compagnie_id && user.pivot.droits_add == 1"><span>Ajouter
              compte</span></button></NuxtLink>
      </div>

      <div class="mobile-btn mt-4">
        <NuxtLink to="/comptes/add_compte" v-for="(user, i) in users" :key="i"><button class="custom-btn btn-3"
            v-if="compagny == user.pivot.compagnie_id && user.pivot.droits_add == 1"><span>Ajouter
              compte</span></button></NuxtLink>
      </div>
