<template>
    <div class="modal-overlay"  @click="$emit('close-modal')">
      <div class="modaler" @click.stop>
        <h6 class="text-center">Télécharger la liste des catégories !</h6>
  ...
  <script>
    export default {
      ...
      methods:{
        pdf() {
          this.$axios.get('/categories/download', {
            params: {
            ...
            link.href = url;
            link.setAttribute('download', 'categories.pdf'); //or any other extension
