<template>
  <div>
    ...
    <div class="app-main__outer py-5 px-2">
      <h4>Liste des produits dans le magazin</h4><hr>
      <div class="d-flex">
        <div class="col-md-10">
      ...
      <div class="mobile-btn my-4">
        <NuxtLink to="/produits/add_produit" v-for="(user, i) in users" :key="i"
          ><button
            class="custom-btn btn-3"
            v-if="
              compagny == user.pivot.compagnie_id && user.pivot.droits_add == 1
          ...
          <tbody>
            <tr v-for="(result, j) in results" :key="j">
              ...
              <td class="controler">
                <div class="replace">
                  ...
                  /><i
                    ...
                    aria-hidden="true"
                    @click="replaceQuantity(result.id)"
                  ></i>
                </div>
              </td>
              ...
              <td>
                ...
                >
                  <div
                    @click="voirProduit(result.id)"
                    v-if="compagny == user.pivot.compagnie_id"
                  >
                    <i class="fa fa-info-circle" aria-hidden="true"></i>
                  </div>
                  <NuxtLink
                    :to="'/produits/' + result.id"
                    v-if="
                  ...
                  <div
                    ...
                    v-b-tooltip.hover
                    title="Télécharger l'état de stock"
                    @click="pdfExporte(result)"
                    v-if="compagny == user.pivot.compagnie_id"
                  >
                    <i
                      class="fa fa-download text-success"
                      aria-hidden="true"
                    ></i>
                  </div>
                </div>
        ...
        <table class="table table-hover">
          ...
          <tbody>
            <tr
              ...
              :key="i"
              :class="{ 'col-ligne': produit.quantity == 0 }"
            >
              <td v-if="selection != 0">
                <div class="form-check">
                  <input
              ...
              <td class="controler">
                <div class="replace">
                  ...
                  /><i
                    class="fa fa-check-circle text-primary"
                    aria-hidden="true"
                    @click="replaceQuantity(produit.id)"
                  ></i>
                </div>
              </td>
    ...
    <voirProduit
      :prod_id="identifiant0"
      :id="identifiant1"
      :nom="identifiant2"
      :quantite="identifiant3"
      :vente="identifiant4"
      :achat="identifiant5"
      :min="identifiant6"
      :max="identifiant7"
