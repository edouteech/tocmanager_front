<template>
    <div class="modal-overlay" @click="$emit('close-modal')">
      <div class="modaler" @click.stop>                     
            <p>Etes vous sur de vouloir supprimer définitivement cet employé ??? </p>
            <div class="reponse">
                  <div class="yes"  @click="supClient(infos)">
                      Oui
                  </div>
  ...
  <script>
    export default {
      ...
      methods: {
          supClient(infos){
              console.log(infos);
              this.$axios.delete('/employees/' +infos,{
              params: {
