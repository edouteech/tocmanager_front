...
<div>
        ...
        <div class="app-main__outer py-5">
          ...
          <div class="d-flex">
            ...
            <NuxtLink  to="/employes/add_employe" v-for="(user, i) in users" :key="i" class="web-btn"><button class="custom-btn btn-3" v-if="compagny == user.pivot.compagnie_id && user.pivot.droits_add == 1"><span>Ajouter un employé</span></button></NuxtLink>
          </div>

          <div class="mobile-btn my-4">
            <NuxtLink  to="/employes/add_employe" v-for="(user, i) in users" :key="i"><button class="custom-btn btn-3" v-if="compagny == user.pivot.compagnie_id && user.pivot.droits_add == 1"><span>Ajouter un employé</span></button></NuxtLink>
          </div>
            ...
            <table class="table table-hover">
              ...
              <tbody>
               <tr  v-for="(result, j) in results" :key="j">
                  ...
                  <td>{{result.position_hield}}</td>
                  <td>
                    <div class="action" v-for="(user, i) in users" :key="i">
                      <NuxtLink :to="'/employes/voir/'+result.id" v-if=" compagny == user.pivot.compagnie_id"><i class="fa fa-info-circle text-warning" aria-hidden="true"></i></NuxtLink>
                      <NuxtLink :to="'/employes/'+result.id" v-if=" compagny == user.pivot.compagnie_id && user.pivot.droits_edition == 1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></NuxtLink>
                      ...
                      <div @click="deleteEmploye(result.id)" v-if=" compagny == user.pivot.compagnie_id && user.pivot.droits_delete == 1"><i class="fa fa-trash-o text-danger" aria-hidden="true"></i></div>
                    </div>
                  </td>
                </tr>
              </tbody>
            ...
            <table class="table table-hover" v-if="this.element_search == ''">
              ...
              <tbody>
               <tr  v-for="(employe, i) in employes" :key="i">
                  ...
                  <td>
                    <div class="action" v-for="(user, i) in users" :key="i">
                        <NuxtLink :to="'/employes/voir/'+employe.id" v-if=" compagny == user.pivot.compagnie_id"><i class="fa fa-info-circle text-warning" aria-hidden="true"></i></NuxtLink>
                        <NuxtLink :to="'/employes/'+employe.id" v-if=" compagny == user.pivot.compagnie_id && user.pivot.droits_edition == 1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></NuxtLink>
                        <!-- <div class="cursor-pointer" v-b-tooltip.hover title="Télécharger l'état de commande" @click="stockExporte(employe)" v-if="compagny == user.pivot.compagnie_id"><i class="fa fa-download" aria-hidden="true"></i></div>
                        <div><a :href="'https://api.whatsapp.com/send?phone='+employe.phone+'&text=Salut%0AJe%20souhaite%20en%20savoir%20plus%20sur%20votre%20offre%20d%27emploi!'"><i class="fa-brands fa-whatsapp fa text-success"></i></a></div> -->
                        <div @click="deleteEmploye(employe.id)" v-if=" compagny == user.pivot.compagnie_id && user.pivot.droits_delete == 1"><i class="fa fa-trash-o text-danger" aria-hidden="true"></i></div>
                    </div>
                  </td>
                </tr>
              </tbody>
