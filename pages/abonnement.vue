...
<div class="contain my-5">
    ...
    <div class="col-md-6 mx-auto my-5">
        ...
        <p class="text-center p-offre">Prenez connaissance de nos packs d'abonnement</p>
    </div>
    <div class="row mx-auto">
        <div class="col-md-4 mx-auto offre">
            <h4 class="text-center">{{plan1.name}}</h4><hr>
            <p class="text-center">{{plan1.description}}</p>
            <div class="img">
            ...
            <div>
                ...
                <div class="title-offre col-md-6 mx-auto text-center">{{plan1.price}} {{plan1.currency}}</div>
            </div>
        </div>
        <div class="col-md-4 mx-auto offre">
            ...
            <div>
                <div class="liste">
                    <div class="number-text"><span class="number">1</span><span class="text-liste">{{plan2.trial_period}} JOURS D'ESSAI</span></div><br>
                    <div class="number-text"><span class="number">2</span><span class="text-liste">{{plan2.invoice_period}} ANNEE D'ABONNEMENT</span></div><br>
                    <div class="number-text"><span class="number">3</span><span class="text-liste">ASSISTANCE TECHNIQUE 24H/24</span></div><br>
                    <div class="number-text"><span class="number">4</span><span class="text-liste">FORMATION GRATUITE</span></div><br>
                </div>
                <!-- <button class="btn btn-outline-primary btn-offer p-2">Sélectionner</button> -->
