<template >
  <div>
    <nav class="navbar navbar-fixed-top navbar-dark bg-dark text-white p-3">
      <Sidebar />
      <h3 class="name_side">Ma Compagnie</h3>
      <Userinfo />
    </nav>

    <div class="app-main__outer py-5 px-2">
      <h4>Informations relatives à ma compagnie</h4>
      <hr />
      <div
      ...
      <div class="row">
        <div class="col-lg-5 col-md-12 img mt-5">
          ...
          <div class="form-outline mt-4">
            <span class="fa fa-file-image-o px-2"></span
            ><label class="form-label">Importer logo de la compagnie</label>
        ...
        <div class="col-lg-6 col-md-12 mt-2 ml-5">
          <form action="" method="POST" class="px-5">
            <span class="text-center"
              ><strong>Modifier les informations de la compagnie</strong></span
            >
            <br /><br />
            ...
            <div class="form-outline mb-4">
              <span class="fa fa-sort-numeric-desc px-2"></span
              ><label class="form-label"
                >Numéro d'Identification Fiscale Unique</label
              >
              <div class="input-field">
                <input
                  type="text"
                  ...
                  v-model="form.ifu"
                  required
                  placeholder="Entrer le numéro IFU"
                />
              </div>
            </div>
            <div class="form-outline mb-4">
              <span class="fa fa-exchange px-2"></span
              ><label class="form-label">Régistre de commerce</label>
              <div class="input-field">
                <input
                  type="text"
                  class="form-control form-control-lg"
                  v-model="form.registre"
                  required
                  placeholder="Entrer le régistre"
                />
              </div>
            </div>
            <div class="form-outline mb-4">
              <span class="fa fa-key px-2"></span
              ><label class="form-label">Token de génération de facture</label>
              <div class="input-field">
                <textarea
                  type="textarea"
                  class="form-control form-control-lg"
...
export default {
  ...
  methods: {
    ...
    //modifier infos de la compagnie
    submit() {
      this.$axios
        .put("/compagnies/" + this.compagny, {
          id: this.compagny,
          name: this.form.name,
    ...
    async Logo() {
      ...
      await this.$axios
        .post("/compagnies/" + this.compagny + "/picture", formd, {
          params: {
            compagnie_id: localStorage.getItem("auth.company_id"),
          },
        })
