<template>
    <div class="modal-overlay" @click="$emit('close-modal')">
      <div class="modal" @click.stop>                     
            <p>Etes vous sur de vouloir supprimer définitivement ce congé ??? </p>
            <div class="reponse">
                  <div class="yes"  @click="supConges(infos)">
                      Oui
                  </div>
  ...
  <script>
    export default {
      ...
      methods: {
        supConges(infos){
            //   console.log(infos);
              this.$axios.delete('/destroy/vacations/' +infos)      
              .then(response => {
