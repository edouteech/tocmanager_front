<template>
    <div>
        ...
        <div class="app-main__outer py-5 px-2">
            ...
            <h4>Modifier les informations de ce bulletin de paie</h4><hr>
            <form action="">
                <div class="p-3">
                ...
                <div class="col-md-6 mx-auto mt-4">
                    <button type="submit" class="btn btn-outline-success col-md-12 p-3 " v-on:click.prevent="submit()" :disabled="load">Modifier la fiche de paie</button>
                </div>
            </form>
        ...
        methods: {
            recupPaie(){
                ...
                .then(response => {
                    ...
                    this.fiche = response.data.data
                    // this.id_employe = this.fiche.id
                    this.form.date_start =  moment(this.fiche.date_start).format("YYYY-MM-D")
                    this.form.date_end = moment(this.fiche.date_end).format("YYYY-MM-D")
                    this.form.employee_id = this.fiche.employee.id
                    this.form.lignes = this.fiche.sup_hours
                    this.form.Bonus = this.fiche.bonus
                    this.form.retains = this.fiche.retained
              ...
              await  this.$axios.put('/payslips/'+this.$route.params.id,{
                ...
                this.error = response.data.message
                    ...
                    this.$router.push({path:'/paies/list_paie'});
                        this.$toast("Fiche de paie modifiée !!! ", {
